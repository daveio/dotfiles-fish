...
abbr -a 'bunr' 'bun run'
abbr -a 'c' 'code'
abbr -a 'cc' 'bun x @anthropic-ai/claude-code'
abbr -a 'ci' 'cargo install'
abbr -a 'claude' 'bun x @anthropic-ai/claude-code'
abbr -a 'cm' 'chezmoi'
...
abbr -a 'tw' 'gittower'
abbr -a 'u' 'upctl'
abbr -a 'up' 'sudo chown -R dave:staff /opt/homebrew; topgrade; mise upgrade'
abbr -a 'v' 'vue'
